...
from model_r2_unet import R2unet, init_weights
...
ckp_path = '/app/checkpoints/cv_task2/'     # checkpoint save path 
logs_path = '/app/logfiles/cv_task2_logs'   # logs save path
###### data folder create #####
